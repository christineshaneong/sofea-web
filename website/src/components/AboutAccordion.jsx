...
const AboutAccordion = () => {
  ...
  const [sections, setSections] = useState([
    ...
    // --- NEWS MOVED HERE ---
    { id: 'news', title: 'LATEST NEWS', description: 'Stay updated with the latest headlines and announcements.', img: null, path: '/news' },
    ...
    { id: 'shop', title: 'THE SHOP', description: 'Exclusive SOF-EA gear. Limited drops for the community.', img: null, path: '/shop' }, 
      ...
      {sections.map((section) => (
        ...
        >
          ...
          <div className="absolute inset-0 z-10 pointer-events-none flex flex-col justify-center items-center">
            {/* Title rotates back to 0deg on hover */}
